...
<div class="page__bd">
	<div class="weui-panel">
		<div class="weui-cells no_magrin_top">
			...
			<div class="weui-cell">
				<div class="weui-cell__hd size_14">订单状态：</div>
				<div class="weui-cell__bd size_14">已付款</div>
			</div>
		</div>
		<div class="weui-panel__bd">
			...
			<p class="text_right padding_new size_14">共计：¥36</p>
		</div>
	</div>
	...
	<div class="page__bd">
		<div class="weui-flex">
			<div class="weui-flex__item">
				<a href="javascript:;" class="weui-btn weui-btn_primary btn_new size_14">取消订单</a>
			</div>
			<div class="weui-flex__item">
				<a href="javascript:;" class="weui-btn weui-btn_primary btn_small btn_new size_14">付款</a>
			</div>
		</div>
