...
<div class="weui-form-preview">
	...
	<div class="weui-form-preview__bd">
		<div class="weui-form-preview__item">
			<label class="weui-form-preview__label">配送地址</label>
			<span class="weui-form-preview__value">XXXXXXXXXX</span>
		</div>
		<div class="weui-form-preview__item">
		...
		<div class="weui-form-preview__item">
			...
			<span class="weui-form-preview__value">5+652326578456165489456</span>
		</div>
		<div class="weui-form-preview__item">
...
<div class="weui-cells wc">
	<div class="weui-cell">
		<a href="#" class="weui-btn weui-btn_primary">付款</a>
	</div>
</div>
