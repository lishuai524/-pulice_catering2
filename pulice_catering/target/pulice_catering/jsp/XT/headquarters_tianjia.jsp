...
<form class="layui-form" action="/headquarters/headquarters/insert_headquarters.do" enctype="multipart/form-data" method="post">
        ...
        <div class="layui-input-inline">
            <select name="manager">
                <c:forEach var="staffs" items="${staffsList}">
                    <option value="${staffs.name}">${staffs.name}(${staffs.job_number}-${staffs.role}-${staffs.department})</option>
                </c:forEach>
            </select>
        </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="time" name="start_business_hours" placeholder="请输入" class="layui-input">
            <input type="time" name="end_business_hours" placeholder="请输入" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
